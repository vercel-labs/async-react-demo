...
export const comments: Comment[] = [
  {
    ...
    taskId: "1",
    userName: "Marcus",
    content: "I can help with the backend API changes needed for this.",
    createdAt: new Date(now - 1 * day),
  },
  {
    id: "c2",
  ...
  },
  {
    ...
    taskId: "2",
    userName: "Sarah",
    content: "This is happening in production too. Users are reporting it.",
    createdAt: new Date(now - 2 * day),
  },
  {
    id: "c4",
    taskId: "5",
    userName: "Jordan",
    content: "I can set up the staging PostgreSQL instance this week.",
  ...
  },
  {
    ...
    taskId: "7",
    userName: "Sarah",
    content: "Let me know if you need the breakpoint specs from the design.",
  ...
  },
  {
    ...
    taskId: "8",
    userName: "Marcus",
    content: "Should we use a dedicated search service or keep it in-app?",
    createdAt: new Date(now - 6 * hour),
  },
  {
    id: "c7",
    taskId: "10",
    userName: "Elena",
    content: "The competitor analysis is done. Sharing the doc now.",
    createdAt: new Date(now - 1 * day),
  },
  {
    id: "c8",
    taskId: "1",
    userName: "Jordan",
    content: "Deployed the preview — check it out and leave feedback.",
